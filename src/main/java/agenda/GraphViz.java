...
public class GraphViz {
    ...
    private String fileType = "gif";

    /**
     * Constructor: creates a new GraphViz object that will contain
     * a graph.
     */
    public GraphViz(String fileType) {
    ...
    private byte[] get_img_stream(File dot)
    {
        ...
        try {
            img = File.createTempFile("graph_", this.fileType, new File(this.TEMP_DIR));

            Runtime rt = Runtime.getRuntime();
            String cmd = DOT + " -T" + this.fileType + " " + dot.getAbsolutePath() + " -o" + img.getAbsolutePath();
